...
var ForecastEmbed = function(e) {
    var t = {},
        ...
        a = function() {
            $(window).width() < 400 ? ($("body").addClass("hide_daily"), i.pause()) : ($("body").removeClass("hide_daily"), i.play())
        },
        f = function(t) {
        ...
        l = function(t) {
            ...
            var r = $('<div class="fe_day">           <span class="fe_label">MON</span>           <canvas class="fe_icon" width="52" height="52" style="width:26px; height:26px" />           <div class="fe_temp_bar">             <span class="fe_high_temp">72&deg;</span>             <span class="fe_low_temp">50&deg;</span>           </div>         </div>'),
                ...
                l, c, h = -Infinity,
                p = Infinity;
            for (var d = 0; d < f; d++) l = a[d], l.temperatureMax > h && (h = l.temperatureMax), l.temperatureMin < p && (p = l.temperatureMin);
            var v = 82,
                m = h - p,
                g, y;
    ...
    return t.loading = function(e) {
        ...
        n.find(".fe_title .fe_forecast_link a").attr("href", "https://darksky.net/" + e.latitude + "," + e.longitude), f(e), l(e), c(e), $("body").hasClass("hide_daily") || i.play()
    }, s(), t
};
